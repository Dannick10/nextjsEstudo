...
const RespostaComponent = ({ resposta, letra, indice, corletra, respostafornecida }) => {
  console.log(resposta);
  return (
    <div className="flex p-2 max-w-[80vw] bg-white text-black font-bold rounded-md m-2 relative self-stretch" onClick={() => respostafornecida(indice)}>
